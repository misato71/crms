...
<template>
    <div>
        <div class="fixed w-screen bg-gray-100">
                        ...
                        <div class="flex">
                            ...
                            <div class="shrink-0 flex items-center">
                                <Link :href="route('customers.index')">
                                    <ApplicationLogo
                                        class="block w-12 text-gray-800"
                                    />
                                </Link>
                            </div>
                ...
                >
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        ...
                        <div class="mt-3 space-y-1">
                            <ResponsiveNavLink :href="route('logout')" method="post" onclick="return confirm('ログアウトします。よろしいですか？') " as="button">
                                Log Out
                            </ResponsiveNavLink>
                        </div>
                    </div>
            ...
            <div class="flex">
                <!-- サイドバー -->
                <div class="bg-white h-screen w-1/6 p-4">
                    <div class="py-4 text-gray-500">
                    <!-- サイドバーのコンテンツ -->
                    <div class="ml-6 text-lg font-bold text-gray-500">
                        Main
                    </div>                    
                    <ul class="mt-6">
