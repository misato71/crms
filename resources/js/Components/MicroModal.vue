        ...
        <main class="modal__content" id="modal-1-content">
          ...
          <div class="mx-auto max-w-xl">
            <div class="grid grid-cols-12 gap-5">
              ...
              <div class="col-span-12 pl-2">
                <button @click="createCustomer" class="flex mx-auto mt-16 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded">登録する</button>
              </div>
            </div>
          </div>
